			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-8">
						...
						<div class="col-md-12">
							<div class="row">
								<span class="badge badge-white" style="font-size:14px;">
						...
						<div class="col-md-12">
							<div style="padding:10px;margin-left:-25px;" class="d-flex w-100 align-items-center">
								<?php if(!empty($avatar)): ?>
					...
					<div class="col-md-4 border-left">
						...
						?>
						<h3 style="margin:40"><b>Recommended</b></h3>
