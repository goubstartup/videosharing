...
Class Action {
	...
	public function isVideoShort($videoPath, $shortDurationThreshold = 30) {
		require_once 'vendor/autoload.php'; // Include the getID3 library
		...
		// Check for errors
		if (isset($file['error'])) {
			throw new Exception("Error analyzing video: {$file['error']}");
		}
	
		$duration = $file['playtime_seconds'];
	
		return $duration <= $shortDurationThreshold;
	}
	...
	function save_upload(){
		...
		$shortThreshold = 15; // Consider videos under 15 seconds as short
